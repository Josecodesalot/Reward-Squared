package com.example.rewardsmanager.Utils;
...
import com.example.rewardsmanager.Activity.LoginActivity;
import com.example.rewardsmanager.Models.User;
...
public class FirebaseMethods {
    ...
    public void addNewUser(String email, String username){
        ...
        User user = new User(mAuth.getCurrentUser().getUid(), email, username);
